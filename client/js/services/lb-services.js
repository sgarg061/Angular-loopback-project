  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Customer.locations.findById() instead.
        "prototype$__findById__locations": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/locations/:fk",
          method: "GET"
        },

        // INTERNAL. Use Customer.locations.destroyById() instead.
        ...
        // INTERNAL. Use Customer.locations.updateById() instead.
        ...
        // INTERNAL. Use Customer.locations() instead.
        "prototype$__get__locations": {
          isArray: true,
          url: urlBase + "/Customers/:id/locations",
          method: "GET"
        },

        // INTERNAL. Use Customer.locations.create() instead.
        "prototype$__create__locations": {
          url: urlBase + "/Customers/:id/locations",
          method: "POST"
        },

        // INTERNAL. Use Customer.locations.destroyAll() instead.
        "prototype$__delete__locations": {
          url: urlBase + "/Customers/:id/locations",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.locations.count() instead.
        "prototype$__count__locations": {
          url: urlBase + "/Customers/:id/locations/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Customer.locations
     * @header lbServices.Customer.locations
     * @object
     * @description
     *
     * The object `Customer.locations` groups methods
     * manipulating `Location` instances related to `Customer`.
     *
     * Call {@link lbServices.Customer#locations Customer.locations()}
     * to query all related instances.
     */
        ...
        R.locations = function() {
          ...
          var action = TargetResource["::get::Customer::locations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.locations#count
         * @methodOf lbServices.Customer.locations
         *
         * @description
         *
         * Counts locations of Customer.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.locations.count = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::count::Customer::locations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.locations#create
         * @methodOf lbServices.Customer.locations
         *
         * @description
         *
        ...
        R.locations.create = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::create::Customer::locations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.locations#createMany
         * @methodOf lbServices.Customer.locations
         *
         * @description
         *
        ...
        R.locations.createMany = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::createMany::Customer::locations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.locations#destroyAll
         * @methodOf lbServices.Customer.locations
         *
         * @description
         *
        ...
        R.locations.destroyAll = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::delete::Customer::locations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.locations#destroyById
         * @methodOf lbServices.Customer.locations
         *
         * @description
         *
        ...
        R.locations.destroyById = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::destroyById::Customer::locations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.locations#findById
         * @methodOf lbServices.Customer.locations
         *
         * @description
         *
        ...
        R.locations.findById = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::findById::Customer::locations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.locations#updateById
         * @methodOf lbServices.Customer.locations
         *
         * @description
         *
        ...
        R.locations.updateById = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::updateById::Customer::locations"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Location.devices.findById() instead.
        "prototype$__findById__devices": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Locations/:id/devices/:fk",
          method: "GET"
        },

        // INTERNAL. Use Location.devices.destroyById() instead.
        ...
        // INTERNAL. Use Location.devices.updateById() instead.
        ...
        // INTERNAL. Use Location.devices() instead.
        "prototype$__get__devices": {
          isArray: true,
          url: urlBase + "/Locations/:id/devices",
          method: "GET"
        },

        // INTERNAL. Use Location.devices.create() instead.
        "prototype$__create__devices": {
          url: urlBase + "/Locations/:id/devices",
          method: "POST"
        },

        // INTERNAL. Use Location.devices.destroyAll() instead.
        "prototype$__delete__devices": {
          url: urlBase + "/Locations/:id/devices",
          method: "DELETE"
        },

        // INTERNAL. Use Location.devices.count() instead.
        "prototype$__count__devices": {
          url: urlBase + "/Locations/:id/devices/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Customer.locations.destroyById() instead.
        "::destroyById::Customer::locations": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/locations/:fk",
        ...
        // INTERNAL. Use Customer.locations.createMany() instead.
        "::createMany::Customer::locations": {
          isArray: true,
          url: urlBase + "/Customers/:id/locations",
          method: "POST"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Location.devices
     * @header lbServices.Location.devices
     * @object
     * @description
     *
     * The object `Location.devices` groups methods
     * manipulating `Device` instances related to `Location`.
     *
     * Call {@link lbServices.Location#devices Location.devices()}
     * to query all related instances.
     */
        ...
        R.devices = function() {
          ...
          var action = TargetResource["::get::Location::devices"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Location.devices#count
         * @methodOf lbServices.Location.devices
         *
         * @description
         *
         * Counts devices of Location.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.devices.count = function() {
          var TargetResource = $injector.get("Device");
          var action = TargetResource["::count::Location::devices"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Location.devices#create
         * @methodOf lbServices.Location.devices
         *
         * @description
         *
        ...
        R.devices.create = function() {
          var TargetResource = $injector.get("Device");
          var action = TargetResource["::create::Location::devices"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Location.devices#createMany
         * @methodOf lbServices.Location.devices
         *
         * @description
         *
        ...
        R.devices.createMany = function() {
          var TargetResource = $injector.get("Device");
          var action = TargetResource["::createMany::Location::devices"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Location.devices#destroyAll
         * @methodOf lbServices.Location.devices
         *
         * @description
         *
        ...
        R.devices.destroyAll = function() {
          var TargetResource = $injector.get("Device");
          var action = TargetResource["::delete::Location::devices"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Location.devices#destroyById
         * @methodOf lbServices.Location.devices
         *
         * @description
         *
        ...
        R.devices.destroyById = function() {
          var TargetResource = $injector.get("Device");
          var action = TargetResource["::destroyById::Location::devices"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Location.devices#findById
         * @methodOf lbServices.Location.devices
         *
         * @description
         *
        ...
        R.devices.findById = function() {
          var TargetResource = $injector.get("Device");
          var action = TargetResource["::findById::Location::devices"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Location.devices#updateById
         * @methodOf lbServices.Location.devices
         *
         * @description
         *
        ...
        R.devices.updateById = function() {
          var TargetResource = $injector.get("Device");
          var action = TargetResource["::updateById::Location::devices"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Device.poss.findById() instead.
        "prototype$__findById__poss": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Devices/:id/poss/:fk",
          method: "GET"
        },

        // INTERNAL. Use Device.poss.destroyById() instead.
        "prototype$__destroyById__poss": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Devices/:id/poss/:fk",
        ...
        // INTERNAL. Use Device.poss.updateById() instead.
        "prototype$__updateById__poss": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Devices/:id/poss/:fk",
        ...
        // INTERNAL. Use Device.poss() instead.
        "prototype$__get__poss": {
          isArray: true,
          url: urlBase + "/Devices/:id/poss",
          method: "GET"
        },

        // INTERNAL. Use Device.poss.create() instead.
        "prototype$__create__poss": {
          url: urlBase + "/Devices/:id/poss",
          method: "POST"
        },

        // INTERNAL. Use Device.poss.destroyAll() instead.
        "prototype$__delete__poss": {
          url: urlBase + "/Devices/:id/poss",
          method: "DELETE"
        },

        // INTERNAL. Use Device.poss.count() instead.
        "prototype$__count__poss": {
          url: urlBase + "/Devices/:id/poss/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Location.devices.create() instead.
        "::create::Location::devices": {
          url: urlBase + "/Locations/:id/devices",
          method: "POST"
        },

        // INTERNAL. Use Location.devices.createMany() instead.
        "::createMany::Location::devices": {
          isArray: true,
          url: urlBase + "/Locations/:id/devices",
          method: "POST"
        },
        ...
        // INTERNAL. Use Location.devices.destroyAll() instead.
        "::delete::Location::devices": {
          url: urlBase + "/Locations/:id/devices",
          method: "DELETE"
        },

        // INTERNAL. Use Location.devices.count() instead.
        "::count::Location::devices": {
          url: urlBase + "/Locations/:id/devices/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use POS.device() instead.
        "::get::POS::device": {
          url: urlBase + "/POSs/:id/device",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Device.poss
     * @header lbServices.Device.poss
     * @object
     * @description
     *
     * The object `Device.poss` groups methods
     * manipulating `POS` instances related to `Device`.
     *
     * Call {@link lbServices.Device#poss Device.poss()}
     * to query all related instances.
     */
         ...
         */
        R.poss = function() {
          var TargetResource = $injector.get("POS");
          var action = TargetResource["::get::Device::poss"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.poss#count
         * @methodOf lbServices.Device.poss
         *
         * @description
         *
         * Counts poss of Device.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         *  - `count` – `{number=}` - 
         */
        R.poss.count = function() {
          var TargetResource = $injector.get("POS");
          var action = TargetResource["::count::Device::poss"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.poss#create
         * @methodOf lbServices.Device.poss
         *
         * @description
         *
         * Creates a new instance in poss of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.poss.create = function() {
          var TargetResource = $injector.get("POS");
          var action = TargetResource["::create::Device::poss"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.poss#createMany
         * @methodOf lbServices.Device.poss
         *
         * @description
         *
         ...
         * </em>
         */
        R.poss.createMany = function() {
          var TargetResource = $injector.get("POS");
          var action = TargetResource["::createMany::Device::poss"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.poss#destroyAll
         * @methodOf lbServices.Device.poss
         *
         * @description
         *
         * Deletes all poss of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.poss.destroyAll = function() {
          var TargetResource = $injector.get("POS");
          var action = TargetResource["::delete::Device::poss"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.poss#destroyById
         * @methodOf lbServices.Device.poss
         *
         * @description
         *
         * Delete a related item by id for poss.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         *
         *  - `fk` – `{*}` - Foreign key for poss
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.poss.destroyById = function() {
          var TargetResource = $injector.get("POS");
          var action = TargetResource["::destroyById::Device::poss"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.poss#findById
         * @methodOf lbServices.Device.poss
         *
         * @description
         *
         * Find a related item by id for poss.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.poss.findById = function() {
          var TargetResource = $injector.get("POS");
          var action = TargetResource["::findById::Device::poss"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.poss#updateById
         * @methodOf lbServices.Device.poss
         *
         * @description
         *
         * Update a related item by id for poss.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.poss.updateById = function() {
          var TargetResource = $injector.get("POS");
          var action = TargetResource["::updateById::Device::poss"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
         ...
         */
        "createChangeStream": {
          url: urlBase + "/POSs/change-stream",
          method: "POST"
        },

        // INTERNAL. Use Device.poss.findById() instead.
        "::findById::Device::poss": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Devices/:id/poss/:fk",
        ...
        // INTERNAL. Use Device.poss.createMany() instead.
        "::createMany::Device::poss": {
          isArray: true,
          url: urlBase + "/Devices/:id/poss",
          method: "POST"
        },
    ...
    */
    R.modelName = "POS";
        ...
        R.device = function() {
          var TargetResource = $injector.get("Device");
          var action = TargetResource["::get::POS::device"];
          return action.apply(R, arguments);
        };
