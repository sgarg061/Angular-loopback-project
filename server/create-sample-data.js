...
var datastore = server.dataSources.elasticsearch;
// var datastore = server.dataSources.mongo;
...
async.auto({
  destroy_all: function(cb) {
    server.models.Cloud.destroyAll();
    server.models.Reseller.destroyAll();
    server.models.Customer.destroyAll();
    server.models.Location.destroyAll();
    server.models.Device.destroyAll();
    server.models.Camera.destroyAll();
    server.models.POS.destroyAll();
    cb(null);
  },
