...
- Postgres (port: 5432, password for superuser(postgres): solink, database name: call-home)
	- To set up PostgreSQL to run:
		-1. Install version 9.4 or higher from here: http://postgresql.org/download/
		-2. Download pgAdmin III on your computer and open it
		-3. T oget /node ./ to run (as required below), create a new database called 'call-home': right-click "Databases" in your Object Browser on the left, click New Databases, enter name 'call-home'
